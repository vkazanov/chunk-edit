 ...
 - [-] chunk-edit UI
   ...
   - [ ] rework the UI closer something like (multi)occur, wgrep, etc
...
Further ideas:
 ...
 - [ ] chunk expansion within the chunk-edit buffer
 ...
 - [ ] make it possible to include buffers within buffers in Emacs? Feasible but would
   take a lot of time
